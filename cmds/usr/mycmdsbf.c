...
int main(object me, string arg)
{
	...
	if(!arg)
	{
		write(ZJBTSET"b12:"HIG"常用"NOR":mycmds ofen"ZJSEP"b13:"HIY"技能"NOR":mycmds skill"ZJSEP"b14:"HIR"战斗"NOR":mycmds fight"ZJSEP
			"b15:"HIM"任务"NOR":mycmds quest"ZJSEP"b16:"HIW"游戏"NOR":mycmds help"ZJSEP"b17:"HIC"交流"NOR":mycmds liaotian"+"\n");
//		write(ZJTTMENU" 飞行 :help mapb"ZJSEP" 附近 :map view\n");
	...
	"/cmds/usr/liaotian"->main(me);
		...
		write(ZJBTSET"b1:查看"ZJBR"背包:i"ZJSEP"b2:个人"ZJBR"主页:score"ZJSEP"b3:健康"ZJBR"状态:hp"
			ZJSEP"b4:查看"ZJBR"装备:arm"ZJSEP"b5:暂无"ZJBR"设定:look"ZJSEP"b6:暂无"ZJBR"设定:look"ZJSEP"b8:帮会"ZJBR"相关:banghui"
			ZJSEP"b7:队伍"ZJBR"信息"NOR":team"ZJSEP"b9:"YEL"观察"ZJBR"四周"NOR":look"ZJSEP"b10:成就"ZJBR"系统:querytitles"ZJSEP"b11:暂无"ZJBR"设定:look"+"\n");
	else if(arg=="skill")
		write(ZJBTSET"b1:查看"ZJBR"技能:skills"ZJSEP"b2:日常"ZJBR"练功:help liangong"ZJSEP"b3:内力"ZJBR"回血:exert recover"
			...
			ZJSEP"b7:内力"ZJBR"疗疾:exert dispel"ZJSEP"b8:内功"ZJBR"加力:enforce"ZJSEP"b9:战斗"ZJBR"信息:set combatd"ZJSEP"b10:天赋"ZJBR"技能:special"ZJSEP"b11:暂无"ZJBR"设定:look"+"\n");
	else if(arg=="fight")
	{
		str = ZJBTSET;
		for(i=1;i<11;i++)

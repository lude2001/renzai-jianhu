...
int main(object me, string arg)
{
	...
	if(arg=="combatd")
	{
		...
		msg += "逃跑设置:wimpy"ZJSEP;
		msg += "机器人:help liangong"ZJSEP;
		msg += "持续发呆:set keep_idle 1"ZJSEP;
		msg += "取消持续发呆:set keep_idle 0"ZJSEP;
		...
		msg += "显示房子信息:set auto_home 1"ZJSEP;
		msg += "屏蔽房子信息:set auto_home 0"ZJSEP;

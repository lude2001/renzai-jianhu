...
int main(object me, string arg)
{
	...
	str += sprintf(CYN"〖暴击率〗：%s%d/%d(max)"NOR"\n",HIR,(int)ob->query_baoji(),100);
	str += sprintf(CYN"〖五禽戏〗：%s%d/%d(max)"NOR"\n",HIR,(int)ob->query("miji/wu"),500);
	str += sprintf(CYN"〖八段锦〗：%s%d/%d(max)"NOR"\n",HIR,(int)ob->query("miji/ba"),500);
	str += sprintf(CYN"〖六字诀〗：%s%d/%d(max)"NOR"\n",HIR,(int)ob->query("miji/liu"),500);
	str += sprintf("一一一一一一一一一一一一一一一一一一一一\n");

...
int main(object me, string arg)
{
	...
	if(!arg)
	{
		write(ZJBTSET"b12:"HIG"常用"ZJBR"指令"NOR":mycmds ofen"ZJSEP"b13:"HIY"技能"ZJBR"相关"NOR":mycmds skill"ZJSEP"b14:"HIR"战斗"ZJBR"相关"NOR":mycmds fight"ZJSEP
			"b15:"HIM"任务"ZJBR"相关"NOR":mycmds quest"ZJSEP"b16:"HIW"游戏"ZJBR"指南"NOR":mycmds help"ZJSEP"b17:"HIC"频道"ZJBR"交流"NOR":mycmds liaotian"+"\n");
//		write(ZJTTMENU" 飞行 :help mapb"ZJSEP" 附近 :map view\n");
	}
	else if(arg=="liaotian")
	"/cmds/usr/liaotian"->main(me);
	else if(arg=="ofen")
		write(ZJBTSET"b1:查看"ZJBR"背包:i"ZJSEP"b2:个人"ZJBR"主页:score"ZJSEP"b3:健康"ZJBR"状态:hp"
			ZJSEP"b4:查看"ZJBR"装备:arm"ZJSEP"b5:角色"ZJBR"信息:uplv"ZJSEP"b6:地图"ZJBR"相关:help mapb"ZJSEP"b8:帮会"ZJBR"相关:banghui"
			ZJSEP"b7:队伍"ZJBR"信息"NOR":team"ZJSEP"b9:"YEL"随身"ZJBR"商城"NOR":myshop"ZJSEP"b10:成就"ZJBR"系统:querytitles"ZJSEP"b11:乘雕"ZJBR"飞行:help mapb"+"\n");
	else if(arg=="skill")
		write(ZJBTSET"b1:查看"ZJBR"技能:skills"ZJSEP"b2:日常"ZJBR"练功:help liangong"ZJSEP"b3:内力"ZJBR"回血:exert recover"
			...
			ZJSEP"b7:内力"ZJBR"疗疾:exert dispel"ZJSEP"b8:内功"ZJBR"加力:enforce"ZJSEP"b9:环境"ZJBR"设置:set combatd"ZJSEP"b10:天赋"ZJBR"技能:special"ZJSEP"b11:意境"ZJBR"系统:use_yj"+"\n");
	else if(arg=="fight")
	{
		str = ZJBTSET;
		for(i=1;i<11;i++)
		...
		write(ZJBTSET"b1:查看"ZJBR"任务:quest"ZJSEP"b2:使用"ZJBR"八卦:use ba gua"ZJSEP"b3:中止"ZJBR"挂机:unset sign1"
			ZJSEP"b4:异性"ZJBR"兄弟:brothers"ZJSEP"b5:活动:help huodong"ZJSEP"b7:跑环"ZJBR"任务:repeat"ZJSEP"b8:会员"ZJBR"福利:help vip"
			ZJSEP"b6:地图"ZJBR"相关:help mapb"ZJSEP"b9:搜索"ZJBR"本地:search"ZJSEP"b10:秘籍"ZJBR"商城:myshop type 8.书籍类"ZJSEP"b11:乘雕"ZJBR"飞行:help mapb"+"\n");
	else if(arg=="help")
		write(ZJBTSET"b1:更新"ZJBR"公告:help anews"ZJSEP"b2:"HIG"新手"ZJBR"指南"NOR":help newbie"ZJSEP"b3:基本"ZJBR"系统:help"ZJSEP"b4:门派"ZJBR"世家:help menpai"
			ZJSEP"b5:游戏"ZJBR"特色:help feature"ZJSEP"b6:技能"ZJBR"介绍:help skills"ZJSEP"b7:暂无"ZJBR"设定:look"ZJSEP"b8:会员"ZJBR"福利:help vip"
	...
	else if(sscanf(arg,"reset %d",bt)==1)
	{
        ...
        if (me->query("yijing"))
        {
            ...
            foreach (string yjName in keys(me->query("yijing")))
            {
                ...
                msg += yjName + yj_f_name[me->query("yijing/" + yjName + "/type")] + ":mycmds reset " + bt + " " + yjName + yj_f_name[me->query("yijing/" + yjName + "/type")] + "：use_yj use " + yjName + ZJSEP;
            }
    
        }
    
    if (me->query("special_skill/lun"))
    msg += "六道"ZJBR"轮回:mycmds reset "+bt+" 六道"ZJBR"轮回：special lun"ZJSEP;

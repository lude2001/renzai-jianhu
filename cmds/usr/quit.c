...
int main(object me, string arg)
{
	...
	if (me->is_busy() && ! me->query("doing") && ! me->query("javadoing"))
...
//		return notify_fail("你身上背的东西太多了，无法离开这个世界。\n");
	...
	if ((me->query("javadoing") || me->query("doing")||(environment(me)&&environment(me)->query("close_room")) || environment(me)->query("work_room")) && !arg)
	{
		if (! interactive(me))
			return 1;

...
int jjsign()
{
	...
	if(localtime(now)[6]!=6||localtime(now)[2]!=MENPAI_HOUR||localtime(now)[1]>MENPAI_PRE)
		return notify_fail(ZJOBLONG"报名时间：每周"+chinese_number(6)+MENPAI_HOUR+":00-"+MENPAI_HOUR+":10。\n");

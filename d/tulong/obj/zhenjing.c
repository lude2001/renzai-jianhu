...
int do_du(string arg)
{
	...
	/*
		...
		write(ZJOBLONG +"请选择研究的技能：\n"+ZJOBACTS2+ ZJMENUF(2,2,9,30)+
			"研究 易筋锻骨:yanjiu2 yijin-duangu from zhenjing"+ZJSEP+
			"研究 幻阴步:yanjiu2 shexing-lifan from zhenjing"+ZJSEP+
			"研究 摧心掌:yanjiu2 cuixin-zhang from zhenjing"+ZJSEP+
			"研究 九阴白骨爪:yanjiu2 jiuyin-baiguzhao from zhenjing"+
		"\n");
		return 1;
	}
...
*/
	...
	{
		write(HIW "你可以从九阴真经里研究到易筋锻骨（yijin-duangu），幻阴步（shexing-lifan），\n"

...
int inform_all(object me)
{
	...
	if (me->query("family/family_name"))
	{
		...
		case 6:
			...
			break;
		case 7:
			msg += me->query("family/family_name") + "境内，各弟子齐振奋高呼:贺" + me->query("name") + "师兄得武道真意，威震天下！";
			break;
		case 8:
...
int judge_requirement(object me, string type, string yijingName)
{
	...
	if (me->query("myspecial/t" + type + "/level") < same_yijing_number(me, type))
	{

...
LONG);
		...
		set("item_desc", ([
		"练毒指南" : "指令:lianzhi ID 例：lianzhi chixie fen\n"
"                                  \n"
"         配       方              \n"
"                                  \n"
" 赤蝎粉(chixie fen)：断肠草、蛇信子、毒囊     \n"
" 孔雀胆(kongque dan)：腐骨草、千日醉、毒囊     \n"
" 鹤顶红(heding hong)：蛇信子、千日醉、毒囊     \n"
" 断肠散(duanchang san)：断肠草、穿心莲、毒囊     \n"
" 腐肉膏(furou gao)：腐骨草、穿心莲、毒囊     \n"
"                        \n"
"     密   药   配   方 \n"
"\n"
" 五圣散(wusheng san)：分取断肠散、腐肉膏\n"
" 鹤顶红、孔雀胆、赤蝎粉各一份，外加金蛇\n"
" 毒液调制，即可炼成而成。\n"
" 如将密药配法外泄者当杀无赦。\n"
" \n"

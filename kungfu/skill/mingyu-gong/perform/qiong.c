...
void qiong_done(object me)
{
        ...
        tell_object(me, HIY"经过一段时间的休息，你又可以使用「琼楼玉宇」了！"NOR"\n");
...
void check_fight(object me, object target, int bonus)
{
        ...
        {
                message_combatd(WHT"\n$N长舒了一口气，手中的无形劲气也以不似先前一般凌厉了。"NOR"\n", me);
        ...
        {
                message_combatd(HIR"\n$N额头冒汗，看来是内力不随，手上的劲道一下消失不见了。"NOR"\n", me);
                remove_effect(me, bonus);
                return;
        }

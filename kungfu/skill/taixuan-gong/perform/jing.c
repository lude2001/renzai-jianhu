...
int perform(object me, object target)
{
        ...
        if (! objectp(weapon = me->query_temp("armor/hands")) ||!weapon->query("magic/skill/taixuan-gong"))//拥有胡家专属宝石的加成
        {
                return notify_fail("你没有太玄宝石无法使用该绝技。\n");
        }
        ...
        damage = (me->query_skill("unarmed")+(me->query("max_qi")/10))*multiple; 

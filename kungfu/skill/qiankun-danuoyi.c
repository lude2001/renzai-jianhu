...
mixed valid_damage(object ob, object me, int damage, object weapon)
{
	...
	if (objectp(hands = me->query_temp("armor/hands")) && hands->query("magic/skill/qiankun-danuoyi"))
	    sign = 1;
	    
	if (objectp(i_weapon = me->query_temp("weapon")) && i_weapon->query("magic/skill/qiankun-danuoyi"))
	    sign = 1;

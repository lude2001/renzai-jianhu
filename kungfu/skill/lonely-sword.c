...
string query_txt()
{
	return "学习条件:先天悟性大于34,性格需要狡黠多变，基本剑法不能低于独孤九剑等级！";
}
int valid_learn(object me)
{
    ...
    if (me->query("gender") == "无性")
		return notify_fail("你无根无性，阴阳不调，难以领会高深的独孤九剑。\n");
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
	...
	if (((me->query("family/family_name") == "华山剑宗" || lv_fa(me,"华山剑宗")) && i > 50 && random(2) == 0) || ((me->query("family/family_name") == "华山剑宗" || lv_fa(me,"华山剑宗")) && weapon->query("magic/skill/lonely-sword")))
	{
		if (i < 120)
		{

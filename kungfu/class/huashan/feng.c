...
\n"ZJURL("cmds:ask feng qingyang about 破剑式")"破剑式"NOR"、\n"ZJURL("cmds:ask feng qingyang about 破刀式")"破刀式"NOR"、\n"ZJURL("cmds:ask feng qingyang about 破枪式")"破枪式"NOR"、\n"ZJURL("cmds:ask feng qingyang about 破鞭式")"破鞭式"NOR"、
\n"ZJURL("cmds:ask feng qingyang about 破索式")"破索式"NOR"、\n"ZJURL("cmds:ask feng qingyang about 破掌式")"破掌式"NOR"、\n"ZJURL("cmds:ask feng qingyang about 破箭式")"破箭式"NOR"、\n"ZJURL("cmds:ask feng qingyang about 破气式")"破气式"NOR"，

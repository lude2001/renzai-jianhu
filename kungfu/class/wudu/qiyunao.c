...
mixed ask_skill1()
{
        ...
        if (me->can_improve_skill("xiewei-bian"))
                me->improve_skill("xiewei-bian", 150000);
...
mixed ask_skill2()
{
        ...
        if (me->can_improve_skill("strike"))
                me->improve_skill("strike", 150000);
        if (me->can_improve_skill("tianchan-zhang"))
                me->improve_skill("tianchan-zhang", 150000);
...
mixed ask_skill3()
{
        ...
        if (me->can_improve_skill("claw"))
                me->improve_skill("claw", 150000);
        if (me->can_improve_skill("wusheng-zhao"))
                me->improve_skill("wusheng-zhao", 150000);
